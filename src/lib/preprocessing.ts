...
// 조사 패턴 (제거할 조사들)
// (2026-07-04) '이' 제거 — 제품명은 명사구라 조사 '이'가 거의 안 오는데,
// '오이/가시오이/청오이'처럼 명사 끝음절 '이'를 조사로 오인해 "오이→오"로 파괴하던 버그.
// '가'도 유사 위험이나 '이'가 오이류에서 실제 피해가 커 우선 제거.
const PARTICLES = ['은', '는', '가', '을', '를', '의', '도', '만', '까지', '부터', '에서', '으로', '로']
