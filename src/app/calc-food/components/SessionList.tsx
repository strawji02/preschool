...
import { Folder, FileText, MoreVertical, Trash2, Edit3, Loader2, CheckSquare, Square, BarChart3 } from 'lucide-react'
      ...
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          {selectionMode ? (
            ...
            <>
              <Link
                href="/calc-food/proposal-history"
                ...
                title="공식 시작 이후 제안서 발행·변경 현황을 웹에서 확인"
              >
                <BarChart3 size={14} />
                제안서 현황
              </Link>
