...
export function InvoiceViewer({ pages, currentPage, onPageSelect, onReanalyze, isReanalyzing }: InvoiceViewerProps) {
  ...
  if (!currentPageData) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-4 bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <div className="text-center">
          <p className="text-sm font-medium text-gray-700">거래명세표 페이지를 선택하세요</p>
          <p className="mt-1 text-xs text-gray-500">하단 썸네일에서 원하는 페이지를 클릭하세요</p>
        </div>
      </div>
    )
  }
